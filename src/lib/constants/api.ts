...
export const API_ENDPOINTS = {
  ...
  admin: {
    ...
    chatMessages: (conversationId: number) => `/admin/chat/conversations/${conversationId}/messages`,
    chatRead: (conversationId: number) => `/admin/chat/conversations/${conversationId}/read`,
